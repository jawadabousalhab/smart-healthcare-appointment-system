...
INSERT INTO `backups` (`backup_id`,`filename`,`size`,`created_by`,`created_at`) VALUES ('11','backup_2025-04-13_23-38-42.sql','12830','1','2025-04-14 00:38:42');
...
INSERT INTO `system_logs` (`log_id`,`action`,`description`,`created_at`) VALUES ('4','Logs Cleared','All system logs were cleared.','2025-04-14 09:52:55');
...
INSERT INTO `users` (`user_id`,`name`,`email`,`phone_number`,`address`,`profile_picture`,`password`,`role`,`specialization`,`created_at`,`needs_password_setup`,`password_reset_code`,`is_verified`,`verification_code`) VALUES ('20','Jawad Salhab','jawadsalhab21@icloud.com','+96181751709',NULL,NULL,'$2y$10$jtjkPOPrvv2NEtv57bOxmOd1dVWEjWn03XCo1nArLoy/UOhYljZiq','admin',NULL,'2025-04-14 09:44:18','1',NULL,'1',NULL);
